...
input.keypress(function(e) {
	if (e.which == 13) {
		...
		if (inputVal == "help") {
			...
			setTimeout(function() {
				window.open('https://discord.com/invite/GPtPwqQXYf');
			}, 1000);
		} else {
...
function help() {
	var commandsArray = ['Help: List of available commands', '>help', '>contact', '>ping', '>time', '>clear', '>say'];
...
function getTime() {
	Output('<span>It\'s the 21st century man! Get a smartwatch or look at your computer!</span></br>');
}

function contactMe() {
	var contactArray = ['>Contact:', '[Discord](https://discord.com/invite/GPtPwqQXYf)'];
	seperator();
